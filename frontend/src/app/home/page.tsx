...
export default function PaginaInicial() {
    ...
    return (
        <div className="h-[100vh] w-[100vw] flex flex-col overflow-hidden">
            ...
            <div className="bg-gray-300 flex-1 w-full px-2 pt-4 pb-2 overflow-hidden">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-x-6 gap-y-6 overflow-y-auto h-full pr-4">
